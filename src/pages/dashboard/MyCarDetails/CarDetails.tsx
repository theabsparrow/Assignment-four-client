...
// import SameBrandCar from "@/myComponent/sameBrand/SameBrandCar";
// import SameCategoryCar from "@/myComponent/sameCategory/SameCategoryCar";
...
//   return (
//     <section className="md:px-32 min-h-screen bg-gray-100 dark:bg-gray-800  py-2 font-inter">
