...
const DelationSettings = ({ profileInfo }: { profileInfo: TUserByEmail }) => {
    ...
    <section>
      ...
      <div className="py-2 px-4 bg-gray-400 dark:bg-gray-800 rounded-lg mt-4">
        <div className="flex justify-between items-center mb-3">
          <h1 className="text-lg font-bold text-secondary dark:text-gray-100 hover:scale-110 duration-500">
            Delete Account
          </h1>
        </div>
